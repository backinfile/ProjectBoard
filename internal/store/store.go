...
CREATE TABLE IF NOT EXISTS projects(id TEXT PRIMARY KEY, project_key TEXT NOT NULL UNIQUE COLLATE NOCASE, name TEXT NOT NULL, description_markdown TEXT NOT NULL DEFAULT '', archived_at TEXT, project_path TEXT NOT NULL UNIQUE COLLATE NOCASE, default_target_branch TEXT NOT NULL DEFAULT 'main', validation_commands_json TEXT NOT NULL DEFAULT '[]', forbidden_paths_json TEXT NOT NULL DEFAULT '[]', agent_rules_markdown TEXT NOT NULL DEFAULT '', allow_subtasks INTEGER NOT NULL DEFAULT 1, agent_prompts_json TEXT NOT NULL DEFAULT '[]', knowledge_compaction_days INTEGER NOT NULL DEFAULT 7 CHECK(knowledge_compaction_days>=0), knowledge_compaction_request_count INTEGER NOT NULL DEFAULT 20 CHECK(knowledge_compaction_request_count>=0), config_version INTEGER NOT NULL DEFAULT 1, created_at TEXT NOT NULL, updated_at TEXT NOT NULL);
