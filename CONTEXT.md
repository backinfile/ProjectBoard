...
- Persistence: SQLite WAL schema v9 plus file attachments and temporary Agent workspaces under the data directory. Any other schema version is rejected without migration.
