...
执行时间：2026-09-07T07:18:35.747Z。环境：Windows x64，Node v24.14.0，Edge headless；独立本地数据目录和随机回环端口。
...
| 编号 | 测试项 | 结果 | 耗时ms | 错误 |
| --- | --- | --- | --- | --- |
| B001 | 本地进程健康与内嵌资源 | PASS | 155 |  |
| B002 | 首次会话与登录保护 | PASS | 2 |  |
| B003 | 错误初始化凭据 | PASS | 4 |  |
| B004 | 管理员初始化与 Cookie | PASS | 171 |  |
| B005 | 初始化仅一次 | PASS | 156 |  |
| B006 | 请求来源和 CSRF | PASS | 7 |  |
| B007 | 创建项目与设置持久化 | PASS | 2 |  |
| B008 | 项目简称与状态约束 | PASS | 5 |  |
| B009 | 项目归档恢复与自定义状态 | PASS | 3 |  |
| B010 | 修订冲突与原子保存 | PASS | 2 |  |
| B011 | MCP 项目令牌 | PASS | 2 |  |
| B012 | MCP 协议初始化与工具发现 | PASS | 10 |  |
| B013 | MCP 读取修改项目及状态 | PASS | 15 |  |
| B014 | 任务默认字段 | PASS | 15 |  |
| B015 | 所有任务标量设置与清空 | PASS | 195 |  |
| B016 | 任务边界与拒绝后原子性 | PASS | 48 |  |
| B017 | 任务状态、排序与列表分页 | PASS | 30 |  |
| B018 | 过期分页游标 | PASS | 5 |  |
| B019 | 任务清单与三种任务关联 | PASS | 29 |  |
| B020 | 知识树与点分寻址 | PASS | 23 |  |
| B021 | 知识改名移动与稳定引用 | PASS | 56 |  |
| B022 | 知识非法名称与循环 | PASS | 22 |  |
| B023 | 项目标签创建、批量添加和 AND/OR | PASS | 35 |  |
| B024 | 标签移除、改名与合并 | PASS | 25 |  |
| B025 | 跨项目批量操作与搜索范围 | PASS | 20 |  |
| B026 | 评论发表、回复、编辑与列表 | PASS | 21 |  |
| B027 | 评论删除与恢复 | PASS | 20 |  |
| B028 | 空评论及无效回复 | PASS | 11 |  |
| B029 | MCP 附件上传、评论引用与下载 | PASS | 17 |  |
| B030 | 任务详细附件与下载 | PASS | 9 |  |
| B031 | 图片预览 | PASS | 4 |  |
| B032 | 文本编码与原样显示 | PASS | 8 |  |
| B033 | Markdown 排版和源码安全 | PASS | 3 |  |
| B034 | 长文本截断与完整下载 | PASS | 42 |  |
| B035 | 附件范围与非法引用 | PASS | 5 |  |
| B036 | 二进制预览回退 | PASS | 2 |  |
| B037 | 提醒一次投递与已读 | PASS | 11 |  |
| B038 | 每日/每周/月末重复任务 | PASS | 56 |  |
| B039 | 任务删除恢复及标签删除覆盖回收站 | PASS | 23 |  |
| B040 | 知识子树删除计划、提交和恢复 | PASS | 27 |  |
| B041 | 删除计划修订过期 | PASS | 22 |  |
| B042 | 完整 ZIP 备份与恢复 | PASS | 23 |  |
| B043 | 损坏备份与旧修订恢复 | PASS | 3 |  |
| B044 | 预览 JSON 导入 | PASS | 6 |  |
| B045 | MCP 37 工具均实际调用 | PASS | 5 |  |
| B046 | 令牌撤销与请求头项目范围 | PASS | 2 |  |
| B047 | 错误密码、改密及旧会话失效 | PASS | 622 |  |
| B048 | 退出登录与重新登录 | PASS | 158 |  |
| B049 | 非法 JSON、接口方法和深链接 | PASS | 2 |  |
| B050 | 重启持久化与正常停止 | PASS | 306 |  |
| U001 | 管理员首次设置页面 | PASS | 587 |  |
| U002 | 创建项目 | PASS | 126 |  |
| U003 | 创建任务和独立页 | PASS | 190 |  |
| U004 | 任务详细位置和唯一属性入口 | PASS | 24 |  |
| U005 | 详细编辑取消与保存 | PASS | 106 |  |
| U006 | 详细图片上传和缩放 | PASS | 174 |  |
| U007 | 发表评论、回复和删除恢复 | PASS | 195 |  |
| U008 | 评论文件上传和 Markdown/源码/文本预览 | PASS | 158 |  |
| U009 | 附件下载字节 | PASS | 237 |  |
| U010 | 浏览器多页面同步 | PASS | 5601 |  |
| U011 | 看板、列表、时间线和月份导航 | PASS | 357 |  |
| U012 | 知识创建、地址定位和内容自动保存 | PASS | 319 |  |
| U013 | 知识节点历史与置顶 | PASS | 189 |  |
| U014 | 任务和知识导出文件 | PASS | 513 |  |
| U015 | 全局搜索并打开任务 | PASS | 88 |  |
| U016 | 主题保存和移动布局 | PASS | 163 |  |
| U017 | 脚本异常检查 | PASS | 1 |  |
| U018 | 属性添加、清空与标签筛选 | PASS | 367 |  |
| U019 | 评论写入知识与手动历史恢复 | PASS | 362 |  |
| U020 | 我的工作筛选与提醒中心 | PASS | 77 |  |
| U021 | 任务回收站恢复 | PASS | 170 |  |
| U022 | 项目归档与恢复 | PASS | 192 |  |
| U023 | MCP 页面真实读取 | PASS | 74 |  |
| U024 | 看板拖动、自定义状态与删除迁移 | PASS | 321 |  |
| U025 | 复制独立任务链接 | PASS | 53 |  |
| U026 | 知识子树回收站恢复与永久删除 | PASS | 495 |  |
| U027 | 任务永久删除 | PASS | 238 |  |
...
| coverage-html | 0 | 989 |
| frontend | 0 | 164 |
| frozen-preview | 0 | 118 |
| build | 0 | 2165 |
| blackbox | 0 | 2841 |
| browser | 0 | 13429 |
| standalone | 0 | 791 |
| runtime-covdata | 0 | 588 |
| runtime-coverage | 0 | 1004 |
