...
调研时间：2026-08-12。这里记录候选项目与本项目实际采用的模式；GitHub 热度会变化，因此不固化 star 数。
...
| [Docmost](https://github.com/docmost/docmost) | 团队 Wiki、实时协作、空间 | 项目即空间；首版不做实时协同编辑 |
...
| [SilverBullet](https://github.com/silverbulletmd/silverbullet) | 可编程 Markdown 空间、双链 | 单项目空间；首版不做脚本扩展 |
...
| [Athens Research](https://github.com/athensresearch/athens) | 双链与知识图谱 | 图关系有价值，但不适合精简首版 |
...
| [Supermemory](https://github.com/supermemoryai/supermemory) | 文档/记忆摄取与语义检索 | 文件清单与整理有用；首版只做关键词 |
